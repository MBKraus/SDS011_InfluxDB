...
if __name__ == '__main__':
	...
	client = InfluxDBClient('localhost', 8086, 'root', 'root', 'insert_database_name')
	...
	time.sleep(120) # Keep it running for 2 mins just to be sure we get a clean measurement

	pm2_5, pm10 = sensor.query()

	json_body = [
		{
			"measurement": "air_quality_query",
			"tags": {
				"host": "raspberry",
			},
